...
-- ==================================  SHARE FUNCTIONS =========================================
AddEventHandler('rdr_menu:getData', function(cb)
    cb(MenuData)
end)
-- ==================================  SHARE FUNCTIONS =========================================
...
--         label = "Test Option",
--         value = 'test',
--         desc = "Wymagane przedmioty :<br><img src='nui://rdr_weapon_customization/img/LONGARM_GRIPSTOCK_ENGRAVING_2.png' height='33%'><img src='nui://rdr_weapon_customization/img/LONGARM_GRIPSTOCK_ENGRAVING_2.png' height='33%'> <img src='nui://rdr_weapon_customization/img/LONGARM_GRIPSTOCK_ENGRAVING_2.png' height='33%'> <br> Press if you want print text Press if you want print text Press if you want print text Press if you want print text Press if you want print text",
--         subdesc = "test"
--     }, {
--         label = "Test Option",
--         value = 'test',
