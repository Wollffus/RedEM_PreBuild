...
RegisterServerEvent("redemrp_charselect:deleteCharacter", function(_charid)
    ...
    MySQL.query('DELETE FROM ricxgrindstone WHERE `identifier` = @identifier AND `charid` = @characterid;', {identifier = id, characterid=_charid})
    MySQL.query('DELETE FROM ricxgunsmith WHERE `identifier` = @identifier AND `charid` = @characterid;', {identifier = id, characterid=_charid})
    MySQL.query('DELETE FROM ricxcoaches WHERE `identifier` = @identifier AND `charid` = @characterid;', {identifier = id, characterid=_charid})
    MySQL.query('DELETE FROM ricxboats WHERE `identifier` = @identifier AND `charid` = @characterid;', {identifier = id, characterid=_charid})
    MySQL.query('DELETE FROM ricxbirds WHERE `identifier` = @identifier AND `charid` = @characterid;', {identifier = id, characterid=_charid})
    MySQL.query('DELETE FROM ricx_animalnotes WHERE `identifier` = @identifier AND `charid` = @characterid;', {identifier = id, characterid=_charid})
